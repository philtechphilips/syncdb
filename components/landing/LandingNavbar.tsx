...
export const LandingNavbar = ({ onLaunch }: { onLaunch: () => void }) => {
  ...
  return (
    ...
    >
      <div
        className={`mx-auto px-8 flex items-center justify-between transition-all duration-700 rounded-full border border-white/5 ${isScrolled ? "bg-background/40 backdrop-blur-2xl py-3 border-white/10" : "bg-transparent py-5"}`}
      >
        {/* Brand */}
        <Link
          href="/"
        ...
        >
          ...
          <span className="text-lg font-serif tracking-tight text-white -ml-0.5 italic">
            ynqDB
          </span>
        </Link>
