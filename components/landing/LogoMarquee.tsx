...
export const LogoMarquee = () => {
    const row2 = [
        ...
        { name: "Snowflake", icon: "https://raw.githubusercontent.com/devicons/devicon/master/icons/snowflake/snowflake-original.svg" },
    ...
    return (
        <div className="w-full py-20 overflow-hidden relative">
            ...
            <div className="flex flex-col items-center mb-12">
                <span className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.4em] mb-4 text-center">Engine Interoperability</span>
