            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-zinc-500 font-medium max-w-xl mx-auto leading-relaxed">
                        ...
                        <span className="text-white">Made for speed, built for developers.</span>
                    </p>
                    ...
                    <div className="pt-24 flex items-center justify-center gap-12 opacity-10">
                         ...
                         <span className="text-[10px] font-black uppercase tracking-[0.6em] text-white shrink-0">SynqDB universal</span>
                         <div className="h-px flex-1 bg-white" />
                    </div>
                </motion.div>
            </div>
