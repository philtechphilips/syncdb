        ...
        <div className="space-y-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            ...
            >
              ...
              <p className="text-xl text-zinc-500 font-medium leading-relaxed max-w-lg">
                SynqDB is built for high-performance and is optimized for speed.
                Manage your databases without any lag or delays.
              </p>
            </motion.div>

            <div className="flex justify-center lg:justify-end">
              <div className="relative h-64 w-full max-w-sm flex flex-col items-start justify-center">
                <div className="text-[7rem] font-serif text-white/5 italic select-none">
                  0.8ms
                </div>
                <motion.div
                  initial={{ scaleX: 0 }}
                ...
                />
                <span className="text-[10px] font-black text-primary uppercase tracking-[0.5em] mt-4 ml-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            ...
            >
              ...
              <p className="text-xl text-zinc-500 font-medium leading-relaxed max-w-lg">
                Our AI helps you write SQL faster and better. It understands
                your database structure and suggests the right queries for you.
              </p>
            </motion.div>
          </div>
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {[...Array(4)].map((_, i) => (
                        <div
                          key={i}
                          className={`h-1.5 w-full rounded-full ${i === 1 ? "bg-primary/50" : "bg-white/10"}`}
                        />
                      ))}
                    </div>
                  </motion.div>
