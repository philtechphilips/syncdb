    ...
    return (
        <section className="py-32 bg-background relative overflow-hidden flex flex-col justify-center">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
                <div className="mb-24">
                    <span className="text-primary text-xs font-black tracking-[0.4em] uppercase">Reviews</span>
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div className="mt-12 flex items-center gap-6">
                                ...
                                <div>
                                    <div className="text-xl font-black text-white tracking-tight">{reviews[index].name}</div>
                                    <div className="text-zinc-600 text-[9px] font-black uppercase tracking-[0.4em] mt-1">{reviews[index].role}</div>
                                </div>
                            </div>
                        </motion.div>
                    </AnimatePresence>
                ...
                <div className="mt-16 flex items-center gap-4">
                    {reviews.map((_, i) => (
                        ...
                        >
                            <div className={`h-[2px] transition-all duration-500 ${index === i ? 'w-12 bg-primary' : 'w-6 bg-white/10 group-hover:bg-white/30'}`} />
                        </button>
                    ))}
                </div>
                ...
                <div className="mt-20 pt-16 border-t border-white/5 flex flex-wrap gap-16 md:gap-32 opacity-40">
                    {[
                        ...
                        <div key={i} className="text-left group">
                             <div className="text-2xl font-serif text-white group-hover:text-primary transition-colors">{stat.val}</div>
                             <div className="text-[8px] font-black uppercase tracking-[0.3em] text-zinc-500 mt-2">{stat.label}</div>
                        </div>
                    ))}
                </div>
            </div>
