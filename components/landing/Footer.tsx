        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-zinc-500 text-sm font-medium leading-relaxed">
              The industry standard for multi-cloud database orchestration and
              management.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="h-10 w-10 flex items-center justify-center rounded-full border border-white/10 text-zinc-500 hover:text-white hover:border-white transition-all"
              >
