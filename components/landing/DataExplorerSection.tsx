                                        ...
                                        <div className="flex flex-col md:flex-row items-center gap-8">
                                            ...
                                            <div className="flex-1 flex items-center justify-center gap-6">
                                                <div className="flex flex-col items-center gap-2">
                                                    <span className="text-[10px] font-black text-white/20 uppercase tracking-widest">Property</span>
                                                    <span className="text-lg font-bold text-white tracking-tight">status</span>
                                                </div>
                                                <div className="h-8 w-[1px] bg-white/10 hidden md:block" />
                                                <div className="flex flex-col items-center gap-2">
                                                    <span className="text-[10px] font-black text-primary/40 uppercase tracking-widest">Logic</span>
                                                    <span className="text-lg font-medium text-primary italic tracking-tight uppercase">is_not</span>
                                                </div>
                                                <div className="h-8 w-[1px] bg-white/10 hidden md:block" />
                                                <div className="flex flex-col items-center gap-2">
                                                    <span className="text-[10px] font-black text-white/20 uppercase tracking-widest">Value</span>
                                                    <span className="text-lg font-mono font-medium text-white/60 italic tracking-tight">"deleted"</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="space-y-8">
                            ...
                            >
                                ...
                                <p className="text-xl text-zinc-500 font-medium leading-relaxed max-w-sm">
                                    Experience data without the noise. Our explorer delivers results at the leaf with zero latency.
                                </p>
                            </motion.div>
                        </div>
