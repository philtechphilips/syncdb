      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
          ...
          >
            ...
            <div className="text-4xl md:text-5xl font-serif text-zinc-500 leading-none tracking-tighter">
              Free
            </div>
          ...
          >
            ...
            <div className="text-4xl md:text-5xl font-serif text-primary leading-none tracking-tighter italic">
              Custom
            </div>
            <p className="text-xl text-zinc-500 leading-relaxed max-w-xs">
              Unparalleled scale, security, and dedicated infrastructure
              support.
            </p>
            <ul className="space-y-6 text-zinc-400 font-medium">
