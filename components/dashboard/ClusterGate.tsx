        ...
        <div className="w-full max-w-4xl relative z-10 flex flex-col items-center">
          <div className="text-center mb-12 flex flex-col items-center">
            ...
            <div className="flex flex-col mb-6">
              ...
              <span className="text-[10px] font-black text-primary uppercase tracking-[0.3em] opacity-80 mt-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full mb-10">
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-black text-zinc-400 uppercase tracking-wider group-hover:text-white transition-colors">
                    Add Connection
                  </h3>
