        ...
        >
            ...
            >
                <div className="flex items-center gap-2">
                    <TableIcon className={`h-3.5 w-3.5 ${isActive ? 'text-primary' : 'text-primary/80'}`} />
                    <span className={`text-[11px] font-bold ${isActive ? 'text-primary shadow-[0_0_8px_rgba(0,237,100,0.5)]' : 'text-zinc-100'}`}>{node.name}</span>
                </div>
                <button
