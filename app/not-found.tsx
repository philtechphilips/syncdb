  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-2xl w-full">
        ...
        <Link
          href="/"
          className="inline-flex items-center group mb-16 opacity-80 hover:opacity-100 transition-opacity"
        >
          <SynqLogo className="h-10 w-10 text-primary translate-y-[1px]" />
          <span className="text-2xl font-serif tracking-tight text-white -ml-0.5">
            ynqDB
          </span>
        </Link>
        ...
        <div className="relative mb-12 select-none">
          <h1 className="text-[180px] md:text-[240px] font-black text-white/5 leading-none tracking-tighter">
            404
          </h1>
          <div className="absolute inset-0 flex items-center justify-center translate-y-4">
            <div className="flex flex-col items-center gap-6">
              <div className="h-24 w-24 rounded-3xl bg-white/[0.02] border border-white/5 flex items-center justify-center backdrop-blur-sm group">
                <Search className="h-10 w-10 text-primary" />
              </div>
              <h2 className="text-3xl md:text-4xl font-serif text-white max-w-md">
        ...
        <p className="text-zinc-500 font-medium text-lg mb-12 max-w-sm mx-auto leading-relaxed">
          The requested node seems to have been dropped or moved to a different
          coordinate.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/"
            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-primary text-primary-foreground font-black flex items-center justify-center gap-3 transition-all active:scale-95 group"
          >
