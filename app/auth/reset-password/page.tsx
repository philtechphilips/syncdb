...
import { Lock, ArrowRight, Eye, EyeOff, CheckCircle2, Loader2, AlertCircle } from "lucide-react";
    ...
    if (isSuccess) {
        return (
            <div className="text-center py-4 animate-in zoom-in-95 duration-500">
                ...
                <p className="text-zinc-500 font-medium mb-8">Your password has been updated. Redirecting you to login...</p>
            ...
            {(error || localError) && (
                <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20 flex items-start gap-3 text-red-400 text-xs font-medium animate-in fade-in slide-in-from-top-2">
                    ...
                    <div className="flex-1 flex justify-between items-center">
                        ...
                        <button type="button" onClick={clearError} className="hover:text-red-300">✕</button>
                    </div>
                </div>
            )}
        ...
        <div className="min-h-screen bg-background flex flex-col justify-center items-center px-6 py-12">
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-serif text-white mb-2">Create new password</h1>
                    <p className="text-zinc-500 font-medium whitespace-nowrap">Enter a strong password to secure your account.</p>
                </div>

                <div className="glass rounded-3xl p-8 border border-white/5 shadow-2xl">
                    <Suspense fallback={<div className="flex justify-center py-8"><Loader2 className="h-8 w-8 text-primary animate-spin" /></div>}>
                        <ResetPasswordForm />
                    </Suspense>
                </div>
