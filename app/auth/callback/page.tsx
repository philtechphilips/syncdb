    ...
    return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-6 p-6">
            ...
            <div className="text-center space-y-2 relative z-10">
                <h2 className="text-2xl font-serif text-white tracking-tight">Syncing your account</h2>
                <p className="text-zinc-500 font-medium">Securing your session and preparing your dashboard...</p>
            </div>
        </div>
    );
}
