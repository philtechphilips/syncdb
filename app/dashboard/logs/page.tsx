...
export default function LogsPage() {
    ...
    return (
        <div className="flex flex-1 flex-col overflow-y-auto scrollbar-hide bg-[#021016]/20 h-full">
            <div className="p-8 space-y-10 max-w-5xl mx-auto w-full min-h-full">
                {isLoading ? (
                    ...
                    Object.entries(groupedLogs).map(([group, dayLogs]) => (
                        <div key={group} className="space-y-4">
                            ...
                            <div className="divide-y divide-white/[0.02] bg-black/20 rounded-2xl border border-white/5 overflow-hidden backdrop-blur-sm">
                                {dayLogs.map((log) => (
                                    <div key={log.id} className="group flex items-center gap-6 py-4 px-6 hover:bg-white/[0.03] transition-all duration-300">
                                        <div className="flex items-center gap-6 shrink-0 min-w-[160px]">
                                        ...
                                        <div className="flex-1 min-w-0 flex items-center justify-between gap-8">
                                            ...
                                            <div className="flex items-center gap-6 shrink-0">
                                                ...
                                                <button
                                                    ...
                                                    className="p-2.5 rounded-xl bg-white/[0.02] border border-white/5 text-zinc-500 hover:text-white hover:bg-white/[0.05] transition-all opacity-0 group-hover:opacity-100"
